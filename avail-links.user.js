...
// @name           IITC plugin: Available Links
// @category       Layer
// @version        0.4.3.20150208.155807
...
// @description    [jonatkins-2015-02-08-155807] Calculate how to link the portals to create a reasonably tidy set of links/fields. Enable from the layer chooser. (Max Links is a poor name, but remains for historical reasons.)
...
plugin_info.pluginId = 'avail-links';
  ...
  var drawLink = function(a,b) {
    ...
    if (!(b in drawnLinks[a])) {
      ...
      var blatlng = map.unproject (b, window.plugin.maxLinks.PROJECT_ZOOM);
        ...
        // check line does not intersect with existing links
...
window.plugin.maxLinks.setup = function() {
 ...
 window.delaunay.Triangle = function (a, b, c) {
  ...
  window.addLayerGroup('Available links', window.plugin.maxLinks.layer, false);
